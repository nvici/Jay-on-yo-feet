...
db.once('open', async () => {
  ...
  const products = await Product.insertMany([
    ...
    {
      name: 'Jordan 1 Low Washed Denim',
      description:
    ...
    },
    {
      ...
      category: category[0]._id,
      description:
        'This Off-White x Nike Dunk Low is taken from the Dear Summer collection, a sprawling follow-up to Virgil Ablohs first Nike Dunk collaboration from 2019. The low-top makes use of a white leather upper with soft grey suede overlays, along with Virgil Ablohs calling-card flourishes, which include a plastic zip tie and printed Helvetica text. ',
      image: 'offwhite.png',
      price: 500,
      quantity: 75
    },
    {
      name: 'Jordan 1 Retro Low Polka Dot',
      category: category[0]._id,
      description:
    ...
    {
      name: 'Jordan 1 Low Multi Snakeskin',
      category: category[0]._id,
      description:
    ...
    {
      name: 'Voodoo Jordan 1 Retro Low',
      category: category[0]._id,
      description:
